...
urlpatterns = [
  ...
  # Dashboard -> VR
  path('vr-default/', views.vr_default, name='vr_default'),
  path('vr-info/', views.vr_info, name='vr_info'),

  # Pages -> Profile
  path('pages/profile/overview/', views.profile_overview, name='profile_overview'),
